...
<!-- Mirrored from flatfull.com/themes/note/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Apr 2024 14:39:01 GMT -->
    ...
    <section id="content" class="m-t-lg wrapper-md animated fadeInUp">
        <div class="container aside-xxl"> <a class="navbar-brand block" href="index.html">Notebook</a>
            <section class="panel panel-default bg-white m-t-lg">
                ...
                <form action="https://flatfull.com/themes/note/index.html" class="panel-body wrapper-lg">
                    ...
                    <div class="checkbox"> <label> <input type="checkbox"> Keep me logged in </label> </div> <a
                        href="#" class="pull-right m-t-xs"><small>Forgot password?</small></a> <button
