            ...
            <section class="hbox stretch"> <!-- .aside -->
                <aside class="bg-dark aside-md hidden-print hidden-xs" id="nav">
                    <section class="vbox">
                        ...
                        <section class="w-f scrollable">
                            <div class=" " data-height="auto" data-disable-fade-out="true" data-distance="0"
                                ...
                                <nav class="nav-primary hidden-xs">
                                    <ul class="nav">
                                        ...
                                        <li class="active"> <a href="#layout" class="active"> <i
                                                    class="fa fa-columns icon"> <b class="bg-warning"></b> </i> <span
                                            ...
                                            <ul class="nav lt">
                                                ...
                                                <li class="active"> <a href="layout-boxed.html" class="active"> <i
                ...
                <section id="content">
                    <section class="wrapper">
                        <div class="m-b"> <span class="h3 font-thin"><i class="i i-arrow-left3"></i> Boxed Layout</span>
                        </div>
