                                    ...
                                    <ul class="list-group gutter list-group-lg list-group-sp sortable">
                                        ...
                                        <li class="list-group-item box-shadow"> <a href="#" class="pull-right"
                                                ...
                                                class="pull-left media-xs"> <i
                                                    ...
                                                    data-toggle="class:text-lt"> <i class="fa fa-square-o fa-fw text"></i>
                                ...
                                <div class="col-md-4">
                                    <section class="panel b-light">
                                        ...
                                        <div class="list-group"> <a href="#" class="list-group-item text-ellipsis">
                                                <span class="badge bg-danger">7:30</span> Meet a friend </a> <a
                                                href="#" class="list-group-item text-ellipsis"> <span
                                ...
                                <section class="comment-list block">
                                    <article id="comment-id-1" class="comment-item"> <span
                                        ...
                                        <section class="comment-body m-b-lg">
                                            <header> <a href="#"><strong>John smith</strong></a> shared a <a
                                    ...
                                    <article id="comment-id-2" class="comment-reply">
                                        <article class="comment-item"> <a class="pull-left thumb-sm"> <img
                                                    src="{{ url('frontend/images/avatar_default.jpg') }}"
                                                    class="img-circle"> </a>
                                            <section class="comment-body m-b-lg">
